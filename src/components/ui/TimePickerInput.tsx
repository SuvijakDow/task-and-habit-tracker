...
export const TimePickerInput: React.FC<TimePickerInputProps> = ({
  ...
  // Keep input strings synced when tempHours / tempMinutes change via dial
  ...
  // Direct typing handlers inside modal boxes
      ...
      {isOpen && !disabled && (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
          ...
          >
            ...
            {/* Editable Digital Clock Display Header */}
            <div className="flex items-center justify-center gap-3 mb-4">
              <input
                ...
                className={`w-28 h-20 rounded-2xl text-center text-4xl font-extrabold transition-all duration-200 focus:outline-none cursor-text ${
                  mode === 'hours'
            ...
            <div className="relative my-3">
              ...
              >
                {/* SVG Pointer Hand (ALWAYS rendered line from center to selected number) */}
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-10">
                  ...
                  {/* Line from center dot to target Bubble */}
                  <line
                    x1={dialRadius}
                    y1={dialRadius}
                    x2={handX}
                ...
                {/* Hand End Circle Bubble (ALWAYS rendered) */}
                <div
                  style={{
                    left: `${handX}px`,
                    top: `${handY}px`,
